...
- [FossFlow](https://stan-smith.github.io/FossFLOW/) - A Tool to make beautiful isometric infrastructure diagrams [Repo](https://github.com/stan-smith/FossFLOW)

- [4get](https://4get.ca/) - a proxy search engine that doesn't suck

- [SmallDocs](https://sdocs.dev/) - a web markdown editor with export and styling options

- [Spotube](https://github.com/KRTirtho/spotube) - open source Spotify client that doesn't require Premium nor uses Electron! Available for both desktop & mobile!
    > i've donated to that project btw! ❤️

- [Website themes with uBlock Origin](https://darekkay.com/blog/ublock-website-themes/)

- [Displaying Website Content on an E-Ink Display](https://mfasold.net/blog/displaying-website-content-on-an-e-ink-display)
